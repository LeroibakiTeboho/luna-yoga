...
export default function LunaYoga() {
  ...
  const services = [
    {
      ...
      description: "Personalized one-on-one sessions tailored to your needs and goals.",
      icon: (
    ...
    {
      title: "Retreats",
      description: "Immersive experiences in serene locations to deepen your practice.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Flexible classes from the comfort of your home, live or on-demand.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  // Schedule data
  const schedule = [
    { time: "9:00 AM", title: "Morning Flow", description: "Gentle movements to start your day" },
    { time: "12:00 PM", title: "Midday Meditation", description: "Reset your focus for the afternoon" },
    { time: "5:30 PM", title: "Vinyasa", description: "Dynamic flow to energize your evening" },
    { time: "7:00 PM", title: "Restorative Yoga", description: "Deep relaxation for peaceful evenings" },
  ];
    ...
    <div className={`min-h-screen transition-colors duration-500 ${
      ...
      <nav className="fixed w-full z-40 py-4 backdrop-blur-sm bg-white/50">
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          >
            <div className={`p-2 rounded-full ${theme === 'calm' ? 'bg-blue-100' : 'bg-amber-100'}`}>
              <svg xmlns="http://www.w3.org/2000/svg" className={`w-6 h-6 ${theme === 'calm' ? 'text-blue-600' : 'text-amber-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="absolute bottom-0 w-full overflow-hidden">
          <div className="wave-container relative h-32 w-[200%]">
            <div className={`absolute top-0 left-0 w-full h-full ${
              ...
              clipPath: 'polygon(0% 45%, 5% 44%, 10% 46%, 15% 50%, 20% 55%, 25% 58%, 30% 58%, 35% 55%, 40% 50%, 45% 44%, 50% 40%, 55% 41%, 60% 46%, 65% 52%, 70% 55%, 75% 54%, 80% 49%, 85% 45%, 90% 42%, 95% 40%, 100% 41%, 100% 100%, 0% 100%)' 
            }} />
            <div className={`absolute top-0 left-0 w-full h-full ${
              theme === 'calm' ? 'bg-blue-400' : 'bg-amber-400'
            }`} style={{ 
              clipPath: 'polygon(0% 60%, 5% 65%, 10% 70%, 15% 75%, 20% 75%, 25% 70%, 30% 60%, 35% 55%, 40% 55%, 45% 60%, 50% 65%, 55% 65%, 60% 60%, 65% 55%, 70% 50%, 75% 45%, 80% 40%, 85% 35%, 90% 30%, 95% 25%, 100% 20%, 100% 100%, 0% 100%)' 
            }} />
          </div>
        </div>
            ...
            <div className="relative">
              ...
              {schedule.map((cls, index) => (
                ...
                >
                  ...
                  <div className={`ml-6 p-6 rounded-2xl backdrop-blur-sm bg-white/70 shadow-sm w-full ${
                    theme === 'calm' 
                      ? 'border border-blue-200' 
                      : 'border border-amber-200'
                  }`}>
      ...
      <footer className={`py-10 text-center ${
        theme === 'calm' ? 'bg-blue-500 text-white' : 'bg-amber-500 text-white'
      }`}>
        <div className="container mx-auto px-4">
          <p className="mb-4">© {new Date().getFullYear()} Luna Yoga with Maya. All rights reserved.</p>
          <p className="text-sm opacity-80">Find your center through conscious movement.</p>
        </div>
      </footer>
    </div>
  );
...
function BookingModal({ theme, closeModal, bookingStep, nextStep, prevStep }: { 
  theme: 'calm' | 'focus';
  closeModal: () => void;
  bookingStep: number;
  nextStep: () => void;
        ...
        <div className="p-6 md:p-8">
          ...
          <div className="text-center mb-8">
            <div className={`w-16 h-16 mx-auto rounded-full flex items-center justify-center mb-4 ${
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className={`w-8 h-8 ${theme === 'calm' ? 'text-blue-600' : 'text-amber-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
            </div>
            <h3 className="text-2xl font-serif font-bold mb-2">Book Your Session</h3>
            <p className="text-gray-600">Experience personalized yoga with Maya</p>
          </div>
            ...
            {[1, 2, 3].map((step) => (
              <div key={step} className="relative z-10">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                  bookingStep === step 
                    ? (theme === 'calm' ? 'bg-blue-600 text-white' : 'bg-amber-600 text-white')
                  ...
                  {['private', 'retreat', 'online', 'couple'].map(type => (
                    <label 
                      ...
                      className={`p-4 rounded-xl border-2 cursor-pointer transition-colors flex flex-col items-center ${
                        formData.sessionType === type
                          ? (theme === 'calm' ? 'border-blue-500 bg-blue-50' : 'border-amber-500 bg-amber-50')
                    ...
                    >
                      ...
                      <div className={`mb-2 p-2 rounded-full ${
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" className={`w-5 h-5 ${theme === 'calm' ? 'text-blue-600' : 'text-amber-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className={`p-6 rounded-2xl ${
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{formData.date ? `${formData.date} at ${formData.time}` : 'Not selected'}</span>
                  </div>
                  {formData.message && (
